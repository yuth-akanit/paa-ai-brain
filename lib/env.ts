...
const envSchema = z.object({
  ...
  LINE_CHANNEL_ACCESS_TOKEN_CEO_ASSIST: z.string().min(1).optional(),
...
export function getEnv() {
  ...
  cachedEnv = envSchema.parse({
    ...
    LINE_CHANNEL_ACCESS_TOKEN_PA_COOLING: process.env.LINE_CHANNEL_ACCESS_TOKEN_PA_COOLING,
    LINE_CHANNEL_ACCESS_TOKEN_CEO_ASSIST: process.env.LINE_CHANNEL_ACCESS_TOKEN_CEO_ASSIST,
